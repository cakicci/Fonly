  ...
  return (
    <div className="glass-card mx-auto w-full max-w-md rounded-section p-6">
      <div className="mb-6">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-mist">Sade bir başlangıç yap</h1>
