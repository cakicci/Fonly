    ...
    <>
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className={`flex items-center gap-2 rounded-xl border px-3 py-2 text-xs font-medium transition disabled:opacity-50 ${
            inWatchlist
              ...
              : "border-line bg-white/[0.04] text-mist-2 hover:bg-white/[0.07] hover:text-mist"
          }`}
        >
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-line bg-white/[0.04] px-3 py-2 text-xs font-medium text-mist-2 transition hover:bg-white/[0.07] hover:text-mist"
        >
        ...
        <button
          ...
          className="rounded-xl border border-line bg-white/[0.04] p-2 text-mist-2 transition hover:bg-white/[0.07] hover:text-mist"
