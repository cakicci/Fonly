...
import { SplitsSection } from "@/components/events/SplitsSection";
import { BIST_TICKERS } from "@/data/bist-tickers";

type Params = { symbol: string };

export default async function HisseBolunmelerPage({ params }: { params: Params }) {
  ...
  return <SplitsSection splits={events.splits} />;
}
