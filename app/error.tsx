  ...
  return (
    <main className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="glass-card w-full max-w-lg rounded-[1.75rem] p-8 text-center">
        ...
        {error.digest ? (
          <p className="mt-2 text-xs text-mist/35">Hata kodu: {error.digest}</p>
        ) : null}
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/"
            className="inline-flex min-h-11 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-2.5 text-sm font-semibold text-mist/80 transition hover:bg-white/[0.08] hover:text-white"
          >
            Ana sayfaya dön
          </Link>
        </div>
